...
public class MultipleKeysTest {
  ...
  public void test() throws Throwable {
    ...
    final StartTogetherConcurrentTestDriver driver = new StartTogetherConcurrentTestDriver(10) {
      @Override
      protected void doStartTogether(final int index) throws Throwable {
        helper.test(lock, index % 3, 1000);
      }
    };
    driver.runTest();
     ...
     * obtained.
     */
    Assert.assertEquals(3, helper.getMaxSize());

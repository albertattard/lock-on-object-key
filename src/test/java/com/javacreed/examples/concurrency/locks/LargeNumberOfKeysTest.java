 ...
 */
public class LargeNumberOfKeysTest {
  ...
  public void test() throws Throwable {
    ...
    final StartTogetherConcurrentTestDriver driver = new StartTogetherConcurrentTestDriver(500) {
      @Override
      protected void doStartTogether(final int index) throws Throwable {
        helper.test(lock, index % 1000, 10000);
      }
    };
    driver.runTest();
     ...
     * obtained.
     */
    // Assert.assertEquals(1000, helper.getMaxSize());
